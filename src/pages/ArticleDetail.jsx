...
// mock data ini disamakan dengan struktur database backend / admin nantinya
const initialArticlesData = [
  {
    id: 1,
    title: "100 Warga Sudah Ikut Cek Kesehatan Gratis",
    author: "Kesehatan",
    image:
      "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=800&q=80",
    content: `Program pelayanan dan pemeriksaan kesehatan gratis yang diinisiasi oleh platform PROBIT berkolaborasi dengan jajaran tenaga medis profesional lokal mendapat antusiasme luar biasa dari masyarakat setempat...`,
  },
  {
    id: 2,
    title:
      "5 Fakta tentang Hantavirus, Ancaman dari Hewan Pengerat yang Kerap Tak Disadari",
    author: "Kesehatan",
    image:
      "https://images.unsplash.com/photo-1541417904950-b855846fe074?auto=format&fit=crop&w=800&q=80",
    content: `Hantavirus didapati dari penimbul tiga orang kru dan tiga lainnya jatuh sakit di sebuah kapal pesiar bernama MV Island...`,
  },
  {
    id: 3,
    ...
    content: `Rutinitas pekerjaan yang padat serta tuntutan tenggat waktu harian sering kali memicu penumpukan hormon kortisol dalam tubuh manusia...`,
  },
];
...
export default function ArticleDetail() {
  ...
  // Efek memuat detail artikel berdasarkan ID parameter URL
  useEffect(() => {
    window.scrollTo(0, 0);
    const foundArticle = articles.find((item) => item.id === parseInt(id));
    setArticle(foundArticle);
    // Reset search bar setiap kali pindah artikel
    setSearchQuery("");
    ...
    <div className="min-h-screen bg-[#f5f5f5] text-[#0f172a] font-sans antialiased flex flex-col justify-between relative">
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 flex-1 w-full bg-white my-6 shadow-sm rounded-lg sm:px-12">
        ...
        <p className="text-[10px] font-bold text-slate-400 mb-6">
          Oleh: <span className="text-slate-500">{article.author}</span>
        </p>
