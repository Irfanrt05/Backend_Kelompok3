...
export default function Recipes() {
  ...
  const startEdit = (recipe) => {
    ...
    setPreview(
      recipe.image_url ? `http://localhost:5000/${recipe.image_url}` : null,
    );
      ...
      <section className="bg-white p-8 rounded-3xl border-l-4 border-emerald-500 shadow-sm mb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            />
            <textarea
              className="w-full p-4 bg-gray-50 border rounded-2xl h-32 outline-none focus:ring-2 focus:ring-emerald-500"
