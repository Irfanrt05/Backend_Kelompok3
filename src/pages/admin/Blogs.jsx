...
export default function AdminBlogs() {
  ...
  const startEdit = (blog) => {
    ...
    setPreview(`http://localhost:5000/${blog.image_url}`);
    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto bg-gray-50 min-h-screen">
      <header className="mb-10">
        ...
        <p className="text-gray-500 mt-2">
          Kelola konten website Anda dengan tampilan yang lebih fresh.
        </p>
      </header>
      ...
      <section className="bg-white p-8 rounded-3xl border-l-4 border-emerald-500 shadow-sm mb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            />
            <textarea
              className="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl h-32 focus:bg-white focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
      ...
      {viewBlog && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white p-8 rounded-3xl max-w-lg w-full relative animate-in fade-in zoom-in duration-300">
            <button
            ...
            <img
              src={`http://localhost:5000/${viewBlog.image_url}`}
              className="w-full h-64 object-cover rounded-2xl mb-6 shadow-inner"
              alt="view"
            />

            {/* AREA TEKS DENGAN LINE HIJAU */}
            <div className="border-l-4 border-emerald-500 pl-4">
              <span className="text-emerald-600 text-xs font-bold uppercase tracking-wider bg-emerald-50 px-3 py-1 rounded-full">
                {viewBlog.category}
              </span>
              <h2 className="text-2xl font-black text-gray-800 mt-3 mb-2">
                {viewBlog.title}
              </h2>
