...
export default function LandingPage() {
  ...
  // Fungsi untuk animasi scroll mulus saat navbar diklik
  ...
  // Data Dummy untuk Artikel Berita (Sudah disinkronkan untuk Halaman Detail)
  const articles = [
    {
      id: 1,
      ...
      title: "Ratusan Warga Sudah Ikut Cek Kesehatan Gratis",
      desc: "Program kolaborasi Probit bersama tenaga medis lokal berhasil menyisir ratusan warga untuk mendeteksi dini penyakit kronis.",
    },
    {
      id: 2,
      ...
      date: "20 Mei 2026",
      image:
        "https://images.unsplash.com/photo-1505576399279-565b52d4ac71?auto=format&fit=crop&w=500&q=80",
      title: "5 Tips Diet Nutrisi Seimbang, Berawal dari Hidrasi yang Cukup",
      desc: "Mengatur pola makan tidak sesulit yang dikira. Kunci utamanya adalah menjaga keseimbangan makronutrisi dan kecukupan air harian.",
    },
    {
      id: 3,
      ...
      title: "Aktivitas Fisik Ringan Dapat Menurunkan Tingkat Stres Akut",
      desc: "Berjalan kaki selama 15 menit di pagi hari terbukti secara klinis mampu menekan hormon kortisol dan memicu hormon endorfin.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#0f172a] font-sans antialiased">
      ...
      <header className="pt-32 px-4 md:px-8 max-w-7xl mx-auto mb-16">
        <div className="bg-white rounded-[32px] overflow-hidden border border-slate-100 shadow-sm grid grid-cols-1 md:grid-cols-2 items-center min-h-[460px]">
          ...
          <div className="relative w-full h-64 md:h-full min-h-[300px] overflow-hidden bg-slate-50">
            <img
              src="https://images.unsplash.com/photo-1619546813926-a78fa6372cd2?auto=format&fit=crop&w=1000&q=80"
      ...
      {/* 6. SECTION ARTIKEL TERBARU (Seksi Blog dengan Link Detak) */}
      <section className="px-4 max-w-7xl mx-auto mb-24" id="blog">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {articles.map((item) => (
            <Link
              key={item.id}
              to={`/blog/${item.id}`} // Link Routing Aktif
